...
class MakeFigure(object):
    ...
    def init_plotting(self,
        ...
        self.ax = axes([
            0.12 + extra_x_padding, 0.15 + extra_bottom_padding,
            0.78 - extra_x_padding - extra_right_padding,
            0.75 - extra_bottom_padding - extra_top_padding
        ])
        self.fonts = fonts
